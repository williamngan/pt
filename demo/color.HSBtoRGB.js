...
window.demoDescription = "Radiating rectangles in HSB color scheme, whose colors are shifted based on its position and mouse position. With homage to Josef Albers.";
...
var center = space.size.$divide(2).floor();
var mouse = new Color(0,0,0,1,"hsb");
