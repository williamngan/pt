...
window.demoDescription = "Billard balls in different sizes moves in different directions and speeds. They collides with each other and with walls.";
...
var space = new CanvasSpace("pt").setup( {bgcolor: "#223"} );
