...
class Triangle extends Vector
  ...
  # ## Add a vector to both points in this `Triangle`. Same as `Triangle.moveBy`.
  ...
  # ## Same as `pointsAdd()` but returns a new `Triangle`
  $pointsAdd: (args) ->
    a = @_getArgs( arguments )
    return new this.__proto__.constructor( @.$add( a ) ).connect( @p1.$add( a ), @p2.$add( a ) )


  # ## Subtract a vector from both points in this `Triangle`. Same as `Triangle.moveBy`.
  # @param `args` comma-separated values, or as an array, or a Point object.
  # @return this `Triangle`
  pointsSubtract: (args) ->
    a = @_getArgs( arguments )
  ...
  # ## Same as `pointsSubtract()` but returns a new `Triangle`
  $pointsSubtract: (args) ->
    a = @_getArgs( arguments )
    return new this.__proto__.constructor( @.$subtract( a ) ).connect( @p1.$subtract( a ), @p2.$subtract( a ) )


  # ## Multiply a vector with both points in this `Triangle`. Same as `Triangle.scale2D` with anchor at (0,0).
  # @param `args` comma-separated values, or as an array, or a Point object.
  # @return this `Triangle`
  pointsMultiply: (args) ->
    a = @_getArgs( arguments )
  ...
  # ## Same as `pointsMultiply()` but returns a new `Triangle`
  $pointsMultiply: (args) ->
    a = @_getArgs( arguments )
    return new this.__proto__.constructor( @.$multiply( a ) ).connect( @p1.$multiply( a ), @p2.$multiply( a ) )


  # ## Divide with both points in this `Triangle` with a vector. Same as `Triangle.scale2D` with anchor at (0,0).
  # @param `args` comma-separated values, or as an array, or a Point object.
  # @return this `Triangle`
  pointsDivide: (args) ->
    a = @_getArgs( arguments )
  ...
  # ## Same as `pointsDivide()` but returns a new `Triangle`
  $pointsDivide: (args) ->
    a = @_getArgs( arguments )
    return new this.__proto__.constructor( @.$divide( a ) ).connect( @p1.$divide( a ), @p2.$divide( a ) )
